...
<main class="content">
    <div class="row">
        ...
        <div class="col-md-2">
            <select id="paymentModeFilter" name="paymentModeFilter" class="form-control filter">
        ...
        <div class="col-md-2">
            <select id="currencyFilter" name="currencyFilter" class="form-control filter">
        ...
        <div class="col-md-2">
            <select id="projectFilter" name="projectFilter" class="form-control filter">
                <!-- <option value="0">No value</option> -->
        ...
        <div class="col-md-2">
            <select id="paymentFilter" name="paymentFilter" class="form-control filter">
        ...
        <div class="col-md-2">
            <select id="bloggerFilter" name="bloggerFilter" class="form-control filter">
                <!-- <option value="0">No value</option> -->
