                        ...
                        <tbody>
                            ...
                            foreach ($all_projects as $project) : ?>
                                <tr>
                                    ...
                                    <td class="d-xl-table-cell"><a class="badge badge-edit-btn bg-warning" href="<?= base_url() ?>admin/edit-project/<?= md5($project['id']) ?>"> Edit<a></td>
                                    <td class="d-xl-table-cell"><a class="badge badge-edit-btn bg-warning" href="<?= base_url() ?>admin/view-project-leads/<?= md5($project['id']) ?>"> View Leads <?php $ProductsModel = new ProjectsModel();
