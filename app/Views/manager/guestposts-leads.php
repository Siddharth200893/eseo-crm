    ...
    <script>
        $(document).ready(function() {
            ...
            $('.filter').change(function() {
                ...
                var url = '<?= base_url('manager/guestpost-leads-date-range') ?>?start_date=' + start + '&end_date=' + end + '&paymentModeFilter=' + paymentmodeFilter + '&currencyFilter=' + currency + '&projectFilter=' + projectValue + '&paymentFilter=' + paymentValue + '&bloggerFilter=' + blogger + '&urgent_flag=' + urgent_flag + '&invoice_options=' + invoice_options;
                console.log(url);
                $.ajax({
                    url: url,
                    type: "get",
            ...
            $('#export_data').click(function() {
                ...
                // alert(paymentValue);
                // console.log(paymentValue);
                var url = '<?= base_url('manager/exportdata') ?>?start_date=' + start + '&end_date=' + end + '&paymentModeFilter=' + paymentmodeFilter + '&currencyFilter=' + currency + '&projectFilter=' + projectValue + '&paymentFilter=' + paymentValue + '&bloggerFilter=' + blogger + '&urgent_flag=' + urgent_flag + '&invoice_options=' + invoice_options;
                // console.log(url);
