...
<nav id="sidebar" class="sidebar js-sidebar">
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -5) === 'manager' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -5) === 'leads' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager/guest-posting-leads">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -5) === 'users' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager/manage-users">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -4) === 'user' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager/add-user">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -7) === 'project' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager/project">
			...
			<li class="sidebar-item <?php echo substr(current_url(), -8) === 'projects' ? 'active' : ''; ?>">
				<a class="sidebar-link" href="<?= base_url() ?>manager/all-projects">
			...
			<div class="collapse" id="collapseExample">
				<div class="card-body">
					<ul>
						<li class="sidebar-item <?php echo substr(current_url(), -4) === 'mode' ? 'active' : ''; ?>"><a class="sidebar-link" href="<?= base_url() ?>manager/payment-mode">
								<span class="align-middle">Add Payment Mode</span>
							</a></li>
						<li class="sidebar-item <?php echo substr(current_url(), -8) === 'currency' ? 'active' : ''; ?>"><a class="sidebar-link" href="<?= base_url() ?>manager/currency">
			...
			<div class="collapse" id="collapseExample1">
				<div class="card-body">
					<ul>
						<li class="sidebar-item <?php echo substr(current_url(), -8) === 'bloggers' ? 'active' : ''; ?>"><a class="sidebar-link" href="<?= base_url() ?>manager/bloggers">
