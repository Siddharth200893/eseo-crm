                        ...
                        <div class="table-responsive">
                            ...
                            <table id="contact_us_table" class="table default_table table-hover my-0">
                                ...
                                <tbody id="sales_table_body">
                                    <?php
                                    foreach ($bloggers_leads as $guestpost) : ?>
        ...
        $(document).ready(function() {
            ...
            $('#date_range_filter').daterangepicker({
                ...
                function(start, end, label) {
                    var tableRow = null;
                    $.ajax({
                        url: "<?= base_url('manager/guestpost-leads-date-range') ?>",
                        type: "POST",
                        data: {
                            ...
                            if (rowCount <= 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    tableRow += '<tr class="' + aproove_status_text + " " + payment_status_text + '">' +
                                        ...
                                        // '<td>' + row.agent_id + '</td>' +
                                        '<td>' + '<a target="_blank" href="<?= base_url('manager/edit-guestpost/') ?>' + md5(row.id) + '" class="sidebar-link edit-gp-btn  ' +
